...
<root>
  ...
  ├── Editor
  │   ├── Studiob.Blazetween.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Studiob.Blazetween.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Studiob.Blazetween.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Studiob.Blazetween.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Studiob.Blazetween`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package BlazeTween Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Studiob.Blazetween.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Studiob.Blazetween.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Studiob.Blazetween.Editor.Tests.asmdef`

  `Tests/Runtime/Studiob.Blazetween.Tests.asmdef`
